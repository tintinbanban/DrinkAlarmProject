...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static final String NOM_DEFAUT = "nom_defaut";
    public static final String LISTE = "liste_defaut";
    public static final String NOTIFICATIONS = "notifications_new_message_ringtone";
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference(NOM_DEFAUT));
    ...
    private Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            //Partie donnée par AndroidStudio
